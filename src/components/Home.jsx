...
const Home = () => {
  ...
  // Fetch the data from API, manipulates the data and returns the
  // loading state and the movies list
  const { moviesList: updatedMoviesList, isLoading: detailsLoading } =
    useMovieDetailsHandler();
      ...
      <div>
        {detailsLoading ? (
          ...
          <div className="movie-filters-container">
            <MovieFilter
              moviesList={updatedMoviesList} //MOIVELIST1
            />
          </div>
        )}
      </div>
